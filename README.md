...
- **`next/font`** (Inter, Instrument Serif, JetBrains Mono) for zero layout shift
...
portfolio/
├── app/
│   ├── layout.tsx              # metadata, fonts, theme, FOUC script
...
│   ├── theme-provider.tsx      # light/dark context + FOUC script
...
- **Light + dark theming** via CSS variables and a pre-hydration script that prevents flash-of-wrong-theme.
